...
const ONBOARDING_STEPS: ClientOnboardingStep[] = [
  ...
  },
  {
    ...
    description: "Haz clic en el botón de edición sobre tu avatar para subir una foto de perfil.",
  ...
  },
  {
    ...
    description: "Haz clic en la imagen de portada arriba para subir tu foto de fondo.",
